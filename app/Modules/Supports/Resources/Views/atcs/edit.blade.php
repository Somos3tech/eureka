<div id="atcsUpdate" name="atcsUpdate" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="atcsUpdateLabel"
    aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <form id="form-atc" name="form-atc">
                <div class="modal-header">
                    <h5 class="modal-title mt-0" id="myModalLabel"><b>Procesar Gestión ATC No. &nbsp;&nbsp;&nbsp; </b>
                ...
                <div class="modal-body row">
                    ...
                    <div class="col-sm-12">
                        <label for="observation_manager_update" class="col-sm-12 col-form-label"><b>Observación
                                Gestión<small>*</small></b></label>
                        {!! Form::textarea('observation_manager_update', null, [
                            'id' => 'observation_manager_update',
                ...
                <div class="modal-footer">
                    <div class="col-sm-12">
                        <center>
                            <a href="#" title="Procesar" id="update" name="update"
                                class="btn bt-sm btn-info">Procesar</a>
                        </center>
                    </div>
                </div>
        </div>
