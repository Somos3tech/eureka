...
@section('main-content')
    ...
    {!! Form::model($data, [
        'id' => 'customer-edit',
        'name' => 'customer-edit',
        'route' => ['customers.update', (int) $data['id']],
        'method' => 'PUT',
    ]) !!}
    {{ csrf_field() }}
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-sm-2">
                            ...
                            {!! Form::select('state_id', ['' => 'Seleccione Estado...'], $data['state_id'], [
                                'id' => 'state_id',
                            ...
                            <div class="col-sm-3 form-group mb-3">
                                ...
                                <div class="input-group">
                                    <input id="date_register" name="date_register" type="text" class="form-control"
                                        ...
                                        value="{{ $data['date_register'] }}" required>
            ...
            <div class="row">
                <div class="col-sm-12 mb-4 ">
                    ...
                    <center><button id="submit" type="submit" class="btn btn-info" data-toggle="tooltip"
                            data-placement="top" title="Actualizar Información Cliente">Actualizar</button></center>
                </div>
            </div>
        </div>
    </div>
...
@section('page-js')
    ...
    @include('customers::customers.js')
