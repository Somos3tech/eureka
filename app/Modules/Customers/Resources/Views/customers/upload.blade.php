    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{ route('customers.upload') }}" class="dropzone" id="rif-dropzone">
                    @csrf
                    <div class="fallback">
...
<div id="uploadMercantil" name="uploadMercantil" class="modal fade" tabindex="-1" role="dialog"
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{ route('customers.upload') }}" class="dropzone" id="rm-dropzone">
                    @csrf
                    <div class="fallback">
...
<div id="uploadBank" name="uploadBank" class="modal fade" tabindex="-1" role="dialog"
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{ route('customers.upload') }}" class="dropzone" id="bank-dropzone">
                    @csrf
                    <div class="fallback">
...
<div id="uploadAuthBank" name="uploadAuthBank" class="modal fade" tabindex="-1" role="dialog"
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{ route('customers.upload') }}" class="dropzone" id="auth-bank-dropzone">
                    @csrf
                    <div class="fallback">
...
<div id="uploadContract" name="uploadContract" class="modal fade" tabindex="-1" role="dialog"
    aria-labelledby="uploadAuthBankLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title"><b>Cargar Formalización Contrato Físico</b></h5> <button type="button"
                    class="close" data-dismiss="modal" aria-hidden="true">×</button>
            </div>
            <div class="modal-body">
                <form action="{{ route('customers.upload') }}" class="dropzone" id="contract-dropzone">
                    @csrf
                    <input id="contract_id" name="contract_id" class="contract_id" type="hidden" />
                    <div class="fallback">
                        <input id="file_contract" name="file_contract" type="file" />
                    </div>
                </form>
            </div>
        </div>
...
<!--
<div id="uploadPayment" name="uploadPayment" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="uploadPaymentLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title"><b>Cargar Documento Soporte Pago</b></h5> <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
      </div>
      <div class="modal-body">
        <form action="{{ route('customers.upload') }}" class="dropzone" id="payment-dropzone">
          @csrf
          <div class="fallback">
...
<div id="uploadPaymentSale" name="uploadPayment" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="uploadPaymentSaleLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title"><b>Cargar Documento Soporte Pago</b></h5> <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
