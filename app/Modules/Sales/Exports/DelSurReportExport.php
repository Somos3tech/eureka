...
class DelSurReportExport implements FromCollection, ShouldAutoSize, WithHeadings, WithEvents
{
    public $cont;
    ...
    public function registerEvents(): array
    {
        return [
            AfterSheet::class => function (AfterSheet $event) {
                ...
                $event->sheet->getDelegate()->getStyle('E1:E'.$this->cont)->getNumberFormat();
                $event->sheet->getDelegate()->getStyle('A1:F'.$this->cont)->applyFromArray($styleArray);
                $event->sheet->getDelegate()->getStyle('B1:F'.$this->cont)->getAlignment()->setHorizontal(\PhpOffice\PhpSpreadsheet\Style\Alignment::HORIZONTAL_CENTER);
            },
        ];
    }
}
