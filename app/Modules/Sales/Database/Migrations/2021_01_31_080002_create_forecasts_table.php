...
class CreateForecastsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('forecasts', function (Blueprint $table) {
            ...
            $table->string('refere')->nullable(); //consecutivo de recibo
            ...
            $table->enum('tipnot', ['Efectivo', 'Parcial', 'Deposito', 'Transferencia', 'Postpago', 'Convenio', 'DTE', 'Estandar', 'Financiamiento', 'Comodato', 'Banplus', 'Cero'])->nullable(); //TIPO NOTA
            $table->datetime('payment_date')->nullable(); //fecha
            $table->enum('type_sale', ['basic', 'journey', 'discount'])->nullable();
            ...
            $table->enum('frec_invoice', ['D', 'M'])->nullable(); //FRECUENCIA DE COBRO MENSUAL O DIARIO
            ...
            $table->enum('status', ['G', 'C', 'R', 'P', 'X'])->nullable(); //FRECUENCIA DE COBRO MENSUAL O DIARIO
