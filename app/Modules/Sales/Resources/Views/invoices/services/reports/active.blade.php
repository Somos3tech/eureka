...
@section('main-content')
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card mb-4">
                <div class="card-body">
                    {!! Form::open(['route' => 'services.report.export.active', 'method' => 'POST']) !!}
                    {{ csrf_field() }}
                    <div class="row">
                        ...
                        <div class="col-sm-2">
                            ...
                            {!! form::select(
                                'statusc',
                                ['' => 'Seleccione Status...', 'Activo' => 'Activo', 'Suspendido' => 'Suspendido', 'Cancelado' => 'Cancelado'],
                                null,
              ...
              <div class="col-sm-3">
                ...
                <div>
                  <div class="input-group">
                    <input type="text" id="date_range" name="date_range" class="form-control daterange" placeholder="yyyy-mm-dd | yyyy-mm-dd" readonly />
                  </div>
                </div>
              </div>
            </div>-->
