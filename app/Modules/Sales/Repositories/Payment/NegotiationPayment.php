...
class NegotiationPayment implements PayableInterface
{
    public function pay($request)
    {
        ...
        return ['contract_id' => $request['contract_id'], 'tipnot' => null, 'concept_id' => 2, 'nrocta' => $nrocta, 'nropos' => $nropos, 'refere' => $refere, 'currency_id' => 2, 'amount' => str_replace(',', '', $request['amount']), 'amount_currency' => '1.00', 'conceptc' => serialize($array), 'status' => 'N'];
    }
}
