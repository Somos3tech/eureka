...
class Weekly implements InvoiceMasiveServiceInterface
{
    /****************************************************************************/
    public function fields($request, $row)
    {
        ...
        if ($request->type_weekly == 1) {
            $type_weekly = 'Primera Semana';
        } elseif ($request->type_weekly == 2) {
            $type_weekly = 'Segunda Semana';
        } elseif ($request->type_weekly == 3) {
            $type_weekly = 'Tercera Semana';
        } elseif ($request->type_weekly == 4) {
            $type_weekly = 'Cuarta Semana';
        }
