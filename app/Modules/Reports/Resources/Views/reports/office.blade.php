...
@section('main-content')
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card mb-4">
                <div class="card-body">
                    {!! Form::open(['route' => 'reports.office.export', 'method' => 'GET']) !!}
                    {{ csrf_field() }}
                    <div class="row">
                        ...
                        <div class="col-sm-2">
                            ...
                            {!! form::select(
                                'orderstatus',
                                ['' => 'Seleccione Status...', 'Despacho' => 'Despacho', 'Entregado' => 'Entregado'],
                                null,
                                ['id' => 'orderstatus', 'class' => 'form-control', 'value' => old('orderstatus')],
                            ) !!}
                        </div>
                        ...
                        <div class="col-sm-3">
                            ...
                            {!! form::select(
                                'type_posted',
                                ['' => 'Seleccione Tipo Entrega...', 'Presencial' => 'Presencial', 'Courier' => 'Courier'],
                                null,
                                ['id' => 'type_posted', 'class' => 'form-control'],
                            ) !!}
                        </div>
