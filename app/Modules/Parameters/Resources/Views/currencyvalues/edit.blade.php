<!-- modal content -->
<div id="currencyvaluesUpdate" class="modal fade bs-example-modal-center" tabindex="-1" role="dialog"
    aria-labelledby="currencyvaluesUpdateLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-header">
                <h5 class="modal-title mt-0" id="myModalLabel"><b>Actualizar Registro Divisa</b></h5>
                ...
                <div class="form-group row">
                    <div class="col-sm-5 p-2">
                        ...
                        <div class="input-group p-1">
                            <p>&nbsp;</p>
                            <input type="text" class="form-control" id="date_value_up" name="date_value_up"
