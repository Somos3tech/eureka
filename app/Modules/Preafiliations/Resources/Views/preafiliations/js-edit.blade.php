  <script type="text/javascript">
      ...
      $.get('/states/select', function(data) {
          ...
          $("#state_id option[value=" + {{ $data[0]['state_id'] }} + "]").attr("selected", true);
      ...
      /****************************************************************************/
      //Select Ciudad
      $.get('/cities/select?state=' + {{ $data[0]['state_id'] }}, function(data) {
          if (data.length == '') {
              ...
              $("#city_id option[value=" + {{ $data[0]['city_id'] }} + "]").attr("selected", true);
          }
      });
      /****************************************************************************/
      ...
      $.get('/currencies/select', function(data) {
          ...
          $("#currency_id option[value=" + {{ $data[0]['currency_id'] }} + "]").attr("selected", true);
      });
      /****************************************************************************/
      //Select Banco
      $.get('/banks/select', function(data) {
          ...
          $("#bank_id option[value=" + {{ $data[0]['bank_id'] }} + "]").attr("selected", true);
      });
      /****************************************************************************/
      $.get('/cactivities/select', function(data) {
          ...
          $("#cactivity_id option[value=" + {{ $data[0]['cactivity_id'] }} + "]").attr("selected", true);
      });
      /****************************************************************************/
      $.get('/mterminals/select?filter=active', function(data) {
          ...
          $("#modelterminal_id option[value=" + {{ $data[0]['modelterminal_id'] }} + "]").attr("selected",
              true);
      });
      /****************************************************************************/
      $.get('/operators/select', function(data) {
          ...
          $("#operator_id option[value=" + {{ $data[0]['operator_id'] }} + "]").attr("selected", true);
      });
      /****************************************************************************/
      $.get('/companies/select/zone-valid', function(data) {
          ...
          $("#company_id option[value=" + {{ $data[0]['company_id'] }} + "]").attr("selected", true);
      });
      /****************************************************************************/
      $.get('/terms/select?type_condition=Fijo', function(data) {
          ...
          $("#term_id option[value=" + {{ $data[0]['term_id'] }} + "]").attr("selected", true);
      });
      /****************************************************************************/
      $.get('/pmethods/select', function(data) {
          ...
          $("#pmethod_id option[value=" + {{ $data[0]['pmethod_id'] }} + "]").attr("selected", true);
      });
  </script>
