...
class ReportProgrammerExport implements FromCollection, ShouldAutoSize, WithHeadings, WithEvents
{
    public $cont;
    ...
    public function collection()
    {
        ...
        $data = $q->whereNull('orders.deleted_at')->orderBy('order_status', 'DESC')->orderBy('programmer_user', 'DESC')->orderBy('updated_at', 'ASC')->distinct('inv.tipnot')->get();
