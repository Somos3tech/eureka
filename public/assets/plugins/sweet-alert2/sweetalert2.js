...
(function (global, factory) {
    ...
    var existingSweetContainers = document.getElementsByClassName(
        swalClasses.container
    );
    ...
    var init = function init() {
        if (typeof document === "undefined") {
            ...
            document.getElementsByClassName(swalClasses.container).length
        ) {
            return;
        }
        ...
        var rangeOutput = modal.querySelector(
    ...
    var setParameters = function setParameters(params) {
        ...
        for (var param in params) {
            if (
                !defaultParams.hasOwnProperty(param) &&
                param !== "extraParams"
            ) {
        ...
        if (params.type) {
            ...
            if (!validType) {
                console.error(
                    "SweetAlert2: Unknown alert type: " + params.type
                );
                return false;
            }
    ...
    var modalDependant = function modalDependant() {
        ...
        return new Promise(function (resolve, reject) {
            ...
            if (typeof MutationObserver !== "undefined" && !swal2Observer) {
                swal2Observer = new MutationObserver(
                    sweetAlert.recalculateHeight
                );
    ...
    sweetAlert.setDefaults = function (userParams) {
        if (
            !userParams ||
            (typeof userParams === "undefined"
                ? "undefined"
                : _typeof(userParams)) !== "object"
        ) {
