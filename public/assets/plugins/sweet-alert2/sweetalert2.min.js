            ...
            if (!document.getElementsByClassName(n.container).length) {
                ...
                return (
                    ...
                    (t.onkeydown = function (e) {
                        setTimeout(function () {
                            13 === e.keyCode &&
                                (e.stopPropagation(), F.clickConfirm());
                        }, 0);
                    }),
                    (o.onchange = function () {
                        F.resetValidationError();
                    ...
                    (r.onchange = function () {
                        F.resetValidationError(),
                            (r.previousSibling.value = r.value);
                    }),
                    (l.onchange = function () {
                        F.resetValidationError();
                    }),
        ...
        $ = function () {
            ...
            return new Promise(function (e, t) {
                ...
                var o = function (e) {
                        switch ((e = e || r.input)) {
                            ...
                            case "radio":
                                return (
                                    i.querySelector(
                                        "." + n.radio + " input:checked"
                                    ) ||
                                    i.querySelector(
                                        "." + n.radio + " input:first-child"
                                    )
                                );
                            case "range":
                                return i.querySelector(
                ...
                (c.previousWindowKeyDown = window.onkeydown),
                    ...
                    (F.hideLoading = F.disableLoading =
                        function () {
                            r.showConfirmButton ||
                                (q(v), r.showCancelButton || q(y())),
                                B(v, n.loading),
                                B(i, n.loading),
                                (v.disabled = !1),
                                (h.disabled = !1);
