    ...
    a.fn.TouchSpin = function (b) {
        ...
        return this.each(function () {
            ...
            function i(a) {
                ...
                var b = D.input.val();
                "" !== b &&
                    ((b = Number(D.input.val())),
                    D.input.val(b.toFixed(B.decimals)));
            }
            function j() {
                B = a.extend({}, e, K, k(), b);
            }
            ...
            function t(a) {
                switch (B.forcestepdivisibility) {
                    case "round":
                        return (Math.round(a / B.step) * B.step).toFixed(
                            B.decimals
                        );
                    case "floor":
                        return (Math.floor(a / B.step) * B.step).toFixed(
                            B.decimals
                        );
                    case "ceil":
                        return (Math.ceil(a / B.step) * B.step).toFixed(
                            B.decimals
                        );
                    default:
                        return a;
            ...
            function w() {
                ...
                (E += b),
                    E > B.max &&
                        ((E = B.max), J.trigger("touchspin.on.max"), A()),
            ...
            function x() {
                ...
                (E -= b),
                    E < B.min &&
                        ((E = B.min), J.trigger("touchspin.on.min"), A()),
