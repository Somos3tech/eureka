                        ...
                        e.extend(t.Controller.prototype, {
                            ...
                            destroy: function () {
                                ...
                                (i.width = this.chart.width),
                                    ...
                                    (i.style.width =
                                        this.chart.originalCanvasStyleWidth),
                                    (i.style.height =
                                        this.chart.originalCanvasStyleHeight),
                    ...
                    (t.defaults.global.legend = {
                        ...
                        (t.Legend = t.Element.extend({
                            ...
                            buildLabels: function () {
                                (this.legendItems =
                                    this.options.labels.generateLabels.call(
                                        this,
                                        this.chart
                                    )),
                        ...
                        (t.Tooltip = t.Element.extend({
                            ...
                            getTitle: function () {
                                var t =
                                    ...
                                    i =
                                        this._options.tooltips.callbacks.title.apply(
                                            this,
                                            arguments
                                        ),
                                    a =
                                        this._options.tooltips.callbacks.afterTitle.apply(
                                            this,
                                            arguments
                                        ),
                                    o = [];
                            ...
                            getBeforeBody: function () {
                                var t =
                                    this._options.tooltips.callbacks.beforeBody.apply(
                                        this,
                                        arguments
                                    );
                                return i.isArray(t)
                            ...
                            getAfterBody: function () {
                                var t =
                                    this._options.tooltips.callbacks.afterBody.apply(
                                        this,
                                        arguments
                                    );
                                return i.isArray(t)
                            ...
                            getFooter: function () {
                                var t =
                                    ...
                                    i =
                                        this._options.tooltips.callbacks.footer.apply(
                                            this,
                                            arguments
                                        ),
                                    a =
                                        ...
                                        i.each(
                                            ...
                                            function (t, e) {
                                                if (
                                                    ...
                                                    var i =
                                                            this._chartInstance.getDatasetMeta(
                                                                e
                                                            ),
                                                        o = i.data[a._index];
                                                    if (o) {
                                ...
                                void 0 !== this.options.ticks.min &&
                                    ...
                                    void 0 !== this.options.ticks.max &&
                                        ...
                                        (this.maxIndex =
                                            -1 !== t ? t : this.maxIndex)),
                                    (this.min =
                                        this.chart.data.labels[this.minIndex]),
                                    (this.max =
                                        this.chart.data.labels[this.maxIndex]);
                            },
                            ...
                            draw: function () {
                                if (this.options.display) {
                                    ...
                                    if (
                                                ...
                                                if (
                                                    ...
                                                    if (
                                                        ...
                                                        if (
                                                            ...
                                                            (t.fillStyle =
                                                                this.options.ticks.backdropColor),
                                                                t.fillRect(
                                                                    this
                                                                        .xCenter -
                                                                        g / 2 -
                                        ...
                                        (t.lineWidth =
                                            this.options.angleLines.lineWidth),
                                            (t.strokeStyle =
                                                this.options.angleLines.color);
                                        for (
