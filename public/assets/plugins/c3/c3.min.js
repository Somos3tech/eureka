!(function (a) {
    ...
    function g(a, b) {
        ...
        function f(a) {
            ...
            return (
                d.length > 0 && d[0] > 0 && d.unshift(d[0] - (d[1] - d[0])), d
            );
        }
        function g() {
            var a,
                c = p.copy();
            return (
                b.isCategory && ((a = p.domain()), c.domain([a[0], a[1] - 1])),
                c
            );
        }
        function h(a) {
    ...
    (k.generate = function (a) {
        ...
        (i.initParams = function () {
            ...
            (a.clipId = "c3-" + +new Date() + "-clip"),
                ...
                (a.rotated_padding_right =
                    c.axis_rotated && !c.axis_x_show ? 0 : 30),
        ...
        (i.initWithData = function (a) {
            ...
            (d.axis = new f(d)),
                ...
                d.config.svg_classname &&
                    d.svg.attr("class", d.config.svg_classname),
                (b = d.svg.append("defs")),
                ...
                (c = d.main =
                    d.svg
                        .append("g")
                        .attr("transform", d.getTranslate("main"))),
        ...
        (i.updateSizes = function () {
            ...
            (a.currentWidth = a.getCurrentWidth()),
                ...
                (a.margin = b.axis_rotated
                    ? {
                          top:
                              a.getHorizontalAxisHeight("y2") +
                              a.getCurrentPaddingTop(),
        ...
        (i.updateTargets = function (a) {
            ...
            b.updateTargetsForText(a),
                ...
                b.hasArcType() &&
                    b.updateTargetsForArc &&
                    b.updateTargetsForArc(a),
            ...
            if (
                ...
                P.length
                    ? (H.updateXDomain(P, i, j, k),
                      K.axis_x_tick_values ||
                          (B = H.axis.updateXAxisTickValues(P)))
        ...
        (i.getTranslate = function (a) {
            ...
            return (
                "main" === a
                    ...
                    : "y2" === a
                    ? ((b = e.axis_rotated ? 0 : d.width),
                      (c = e.axis_rotated ? 1 : 0))
                    : "subx" === a
                    ? ((b = 0), (c = e.axis_rotated ? 0 : d.height2))
                    : "arc" === a &&
                      ((b = d.arcWidth / 2), (c = d.arcHeight / 2)),
                "translate(" + b + "," + c + ")"
            );
        }),
        ...
        (i.transformMain = function (a, b) {
            ...
            b && b.axisX
                ? (c = b.axisX)
                : ((c = f.main.select("." + l.axisX)),
                  a && (c = c.transition())),
                b && b.axisY
                    ? (d = b.axisY)
                    : ((d = f.main.select("." + l.axisY)),
                      a && (d = d.transition())),
                b && b.axisY2
                    ? (e = b.axisY2)
                    : ((e = f.main.select("." + l.axisY2)),
                      a && (e = e.transition())),
                ...
                : ((c = new MutationObserver(function (e) {
                      e.forEach(function (e) {
                          "childList" === e.type &&
                              e.previousSibling &&
                              (c.disconnect(),
                              (d.intervalForObserveInserted = a.setInterval(
                                  function () {
                                      b.node().parentNode &&
                                          (a.clearInterval(
                                              d.intervalForObserveInserted
                                          ),
                                          d.updateDimension(),
        ...
        (i.bindResize = function () {
            ...
            if (
                ...
                d
                    ? (d.add && d.remove) ||
                      ((d = b.generateResize()), d.add(a.onresize))
                    : (d = b.generateResize()),
        ...
        (i.parseDate = function (b) {
            ...
            return (
                ...
                (c && !isNaN(+c)) ||
                    a.console.error(
                        "Failed to parse x '" + b + "' to Date object"
                    ),
                c
            );
        }),
        ...
        (i.getScale = function (a, b, c) {
            return (c ? this.d3.time.scale() : this.d3.scale.linear()).range([
                a,
                b,
            ]);
        }),
        ...
        (i.updateScales = function () {
            ...
            (a.xMin = b.axis_rotated ? 1 : 0),
                ...
                (a.y = a.getY(
                    a.yMin,
                    a.yMax,
                    c ? b.axis_y_default : a.y.domain()
                )),
                (a.y2 = a.getY(
                    a.yMin,
                    a.yMax,
                    c ? b.axis_y2_default : a.y2.domain()
                )),
        ...
        (i.getXDomainPadding = function (a) {
            ...
            return (
                ...
                "object" == typeof g.axis_x_padding && v(g.axis_x_padding)
                    ? ((d = m(g.axis_x_padding.left)
                          ? g.axis_x_padding.left
                          : c),
                      (e = m(g.axis_x_padding.right)
                          ? g.axis_x_padding.right
                          : c))
                    : (d = e =
                          "number" == typeof g.axis_x_padding
                              ? g.axis_x_padding
                              : c),
                { left: d, right: e }
            );
        ...
        (i.addName = function (a) {
            ...
            return (
                a &&
                    ((b = c.config.data_names[a.id]),
                    (a.name = void 0 !== b ? b : a.id)),
                a
            );
        }),
        ...
        (i.isOrderDesc = function () {
            var a = this.config;
            return (
                "string" == typeof a.data_order &&
                "desc" === a.data_order.toLowerCase()
            );
        }),
                ...
                f.forEach(function (c) {
                    ...
                    d.isCustomX() || d.isTimeSeries()
                        ? g.indexOf(f) >= 0
                            ...
                            : v(e.data_xs) &&
                              (d.data.xs[c] = d.getXValuesOfXKey(
                                  f,
                                  d.data.targets
                              ))
        ...
        (i.load = function (a, b) {
            ...
            a &&
                ...
                (b.type || b.types) &&
                    a.forEach(function (a) {
                        var d =
                            b.types && b.types[a.id] ? b.types[a.id] : b.type;
        ...
        (i.loadFromArgs = function (a) {
            ...
            a.data
                ...
                : a.json
                ? b.load(
                      b.convertDataToTargets(
                          b.convertJsonToData(a.json, a.keys)
                      ),
                      a
                  )
                : a.rows
                ...
                : a.columns
                ? b.load(
                      b.convertDataToTargets(b.convertColumnsToData(a.columns)),
                      a
                  )
                : b.load(null, a);
        }),
                              ...
                              c.legend &&
                                  c.legend
                                      .selectAll(
                                          "." +
                                              l.legendItem +
                                              c.getTargetSelectorSuffix(a)
                                      )
                                      .remove(),
                              (c.data.targets = c.data.targets.filter(function (
                                  b
                              ) {
                                  return b.id !== a;
                              }));
                ...
                .on("mousemove", function (a) {
                    ...
                    b.dragging ||
                        ...
                        (b.isStepType(a) &&
                            ...
                            (f -= 1),
                        (e = b
                            .filterTargetsToShow(b.data.targets)
                            .map(function (a) {
                                return b.addName(
                                    b.getValueOnIndex(a.values, f)
                                );
                            })),
                        d.tooltip_grouped &&
                            (b.showTooltip(e, this), b.showXGridFocus(e)),
                        (!d.tooltip_grouped ||
                    ...
                    if (!b.hasArcType() && b.toggleShape) {
                        ...
                        b.isStepType(a) &&
                            ...
                            b.main
                                ...
                                .each(function (a) {
                                    (d.data_selection_grouped ||
                                        b.isWithinShape(this, a)) &&
                                        (b.toggleShape(this, a, e),
                                        b.config.data_onclick.call(
                                            b.api,
                                            a,
                                            this
                                        ));
                ...
                .on("mousemove", function () {
                    ...
                    if (!c.dragging && !c.hasArcType(i)) {
                        ...
                        (g =
                            ...
                            c.showXGridFocus(h),
                            (c.isBarType(f.id) ||
                                c.dist(f, a) < e.point_sensitivity) &&
                                (c.svg
                                    .select("." + l.eventRect)
                                    .style("cursor", "pointer"),
                                c.mouseover ||
                                    (e.data_onmouseover.call(c.api, f),
                                    (c.mouseover = f)));
                    }
                })
                .on("click", function () {
                    ...
                    c.hasArcType(f) ||
                        ...
                        b &&
                            (c.isBarType(b.id) ||
                                c.dist(b, a) < e.point_sensitivity) &&
                            c.main
                                .selectAll(
                                    "." +
                                        l.shapes +
                                        c.getTargetSelectorSuffix(b.id)
                                )
                                .selectAll("." + l.shape + "-" + b.index)
                                .each(function () {
                                    (e.data_selection_grouped ||
                                        c.isWithinShape(this, b)) &&
                                        (c.toggleShape(this, b, b.index),
                                        c.config.data_onclick.call(
                                            c.api,
                                            b,
                                            this
                                        ));
                          ...
                          "y" === a &&
                              ...
                              (d =
                                  ...
                                  b.axis.getMaxTickWidth(a) *
                                      Math.cos(
                                          (Math.PI *
                                              (90 - c.axis_y_tick_rotate)) /
                                              180
                                      )),
                          d +
                              (b.axis.getLabelPositionById(a).isInner
                                  ? 0
                                  : 10) +
                              ("y2" === a ? -10 : 0))
        ...
        (i.getShapeOffset = function (a, b, c) {
            var d = this,
                e = d.orderTargets(
                    d.filterTargetsToShow(d.data.targets.filter(a, d))
                ),
                f = e.map(function (a) {
                    return a.id;
                });
            ...
            (b = d.main
                ...
                c
                    ...
                    .style("cursor", function (a) {
                        return e.data_selection_isselectable(a)
                            ? "pointer"
                            : null;
                    }),
                a.forEach(function (a) {
        ...
        (i.redrawLine = function (a, b) {
            return [
                (b
                    ? this.mainLine.transition(Math.random().toString())
                    : this.mainLine
                )
                    .attr("d", a)
        ...
        (i.generateDrawLine = function (a, b) {
            ...
            return (
                ...
                function (a) {
                    var f,
                        h = d.line_connectNull
                            ? c.filterRemoveNull(a.values)
                            : a.values,
                        i = b ? c.x : c.subX,
                        j = g.call(c, a.id),
                        k = 0,
        ...
        (i.redrawArea = function (a, b) {
            return [
                (b
                    ? this.mainArea.transition(Math.random().toString())
                    : this.mainArea
                )
                    .attr("d", a)
            ...
            return (
                ...
                function (a) {
                    ...
                    return (
                        c.isAreaType(a)
                            ? (c.isStepType(a) &&
                                  (f = c.convertValuesToStep(f)),
                              (b = e.interpolate(c.getInterpolate(a))(f)))
                            : (f[0] &&
                                  ((g = c.x(f[0].x)),
                                  (h = c.getYScale(a.id)(f[0].value))),
                              (b = d.axis_rotated
                                  ? "M " + h + " " + g
                                  : "M " + g + " " + h)),
                        b ? b : "M 0 0"
        ...
        (i.updateCircle = function () {
            ...
            (a.mainCircle = a.main
                ...
                a.mainCircle.style(
                    "opacity",
                    a.initialOpacityForCircle.bind(a)
                ),
        ...
        (i.getCircles = function (a, b) {
            ...
            return (
                b
                    ? c.main.selectAll(
                          "." + l.circles + c.getTargetSelectorSuffix(b)
                      )
                    : c.main
        ...
        (i.redrawBar = function (a, b) {
            return [
                (b
                    ? this.mainBar.transition(Math.random().toString())
                    : this.mainBar
                )
                    .attr("d", a)
                    .style("fill", this.color)
        ...
        (i.getBars = function (a, b) {
            ...
            return (
                b
                    ? c.main.selectAll(
                          "." + l.bars + c.getTargetSelectorSuffix(b)
                      )
                    : c.main
        ...
        (i.redrawText = function (a, b, c, d) {
            return [
                (d ? this.mainText.transition() : this.mainText)
                    ...
                    .style(
                        "fill-opacity",
                        c ? 0 : this.opacityForText.bind(this)
                    ),
            ];
        }),
        ...
        (i.setTargetType = function (a, b) {
            ...
            c.mapToTargetIds(a).forEach(function (a) {
                (c.withoutFadeIn[a] = b === d.data_types[a]),
                    (d.data_types[a] = b);
            }),
                a || (d.data_type = b);
        }),
        ...
        (i.isLineType = function (a) {
            ...
            return (
                ...
                [
                    ...
                    "step",
                    "area-step",
                ].indexOf(b.data_types[c]) >= 0
            );
        }),
        (i.isStepType = function (a) {
            var b = o(a) ? a : a.id;
            return (
                ["step", "area-step"].indexOf(this.config.data_types[b]) >= 0
            );
        }),
        (i.isSplineType = function (a) {
            var b = o(a) ? a : a.id;
            return (
                ["spline", "area-spline"].indexOf(this.config.data_types[b]) >=
                0
            );
        }),
        ...
        (i.isArcType = function (a) {
            return (
                this.isPieType(a) || this.isDonutType(a) || this.isGaugeType(a)
            );
        }),
        ...
        (i.tooltipPosition = function (a, b, c, d) {
            ...
            return (
                m
                    ? ((f =
                          (j.width -
                              (j.isLegendRight ? j.getLegendWidth() : 0)) /
                              2 +
                          n[0]),
                      (h = j.height / 2 + n[1] + 20))
                    : ((e = j.getSvgLeft(!0)),
        ...
        (i.getLegendHeight = function () {
            ...
            return (
                a.config.legend_show &&
                    (b = a.isLegendRight
                        ? a.currentHeight
                        : Math.max(20, a.legendItemHeight) *
                          (a.legendStep + 1)),
                b
            );
        }),
        ...
        (i.redrawTitle = function () {
            var a = this;
            a.title
                .attr("x", a.xForTitle.bind(a))
                .attr("y", a.yForTitle.bind(a));
        }),
        ...
        (f.prototype.updateXAxisTickValues = function (a, b) {
            ...
            return (
                ...
                b
                    ? b.tickValues(c)
                    : (d.xAxis.tickValues(c), d.subXAxis.tickValues(c)),
                c
            );
        }),
                ...
                b.axis_x_tick_format &&
                    (n(b.axis_x_tick_format)
                        ...
                        : a.isTimeSeries() &&
                          (c = function (c) {
                              return c
                                  ? a.axisTimeFormat(b.axis_x_tick_format)(c)
                                  : "";
                          })),
                n(c)
                    ? function (b) {
        ...
        (f.prototype.dyForYAxisLabel = function () {
            ...
            return a.config.axis_rotated
                ...
                ? "1.2em"
                : -10 -
                  (a.config.axis_y_inner ? 0 : this.getMaxTickWidth("y") + 10);
        }),
        ...
        (f.prototype.getMaxTickWidth = function (a, b) {
            ...
            return b && h.currentMaxTickWidths[a]
                ...
                : (h.svg &&
                  ...
                  (h.currentMaxTickWidths[a] =
                      0 >= j ? h.currentMaxTickWidths[a] : j),
                  h.currentMaxTickWidths[a]);
        }),
        ...
        (i.getClipPath = function (b) {
            var c =
                a.navigator.appVersion.toLowerCase().indexOf("msie 9.") >= 0;
            return (
                "url(" + (c ? "" : document.URL.split("#")[0]) + "#" + b + ")"
            );
        }),
        ...
        (i.getYAxisClipX = function () {
            var a = this;
            return a.config.axis_y_inner
                ? -1
                : a.getAxisClipX(a.config.axis_rotated);
        }),
        ...
        (i.getAxisClipHeight = function (a) {
            return (
                (a ? this.margin.bottom : this.margin.top + this.height) + 20
            );
        }),
        ...
        (i.updateAngle = function (a) {
            ...
            return g
                ? (f
                      .pie(f.filterTargetsToShow(f.data.targets))
                      .forEach(function (b) {
                          h ||
                              b.data.id !== a.data.id ||
                              ((h = !0), (a = b), (a.index = i)),
        ...
        (i.getArcRatio = function (a) {
            var b = this,
                ...
                d =
                    Math.PI *
                    (b.hasType("gauge") && !c.gauge_fullCircle ? 1 : 2);
        ...
        (i.expandArc = function (b) {
            ...
            return d.transiting
                ? void (c = a.setInterval(function () {
                      d.transiting ||
                          (a.clearInterval(c),
                          d.legend.selectAll(".c3-legend-item-focused").size() >
                              0 && d.expandArc(b));
                  }, 10))
        ...
        (i.redrawArc = function (a, b, c) {
            ...
            (d = h
                ...
                d
                    ...
                    .style("cursor", function (a) {
                        return g.interaction_enabled &&
                            g.data_selection_isselectable(a)
                            ? "pointer"
                            : null;
                    })
                    .style("opacity", 0)
                        ...
                        g.interaction_enabled
                            ? function (a, b) {
                                  ...
                                  d &&
                                      ...
                                      e.toggleShape &&
                                          e.toggleShape(this, c, b),
                                      e.config.data_onclick.call(
                                          e.api,
                                          c,
                                          this
                                      ));
                ...
                h
                    ...
                    .style("font-size", function (a) {
                        return e.isGaugeType(a.data)
                            ? Math.round(e.radius / 5) + "px"
                            : "";
                    })
                    .transition()
                    .duration(a)
                    .style("opacity", function (a) {
                        return e.isTargetToShow(a.data.id) &&
                            e.isArcType(a.data)
                            ? 1
                            : 0;
                    }),
                h
                    ...
                    .style(
                        "opacity",
                        e.hasType("donut") || e.hasType("gauge") ? 1 : 0
                    ),
                e.hasType("gauge") &&
                    (e.arcs
                        .select("." + l.chartArcsBackground)
                        .attr("d", function () {
                            var a = {
                    ...
                    e.arcs
                        ...
                        .attr(
                            ...
                            -1 *
                                (e.innerRadius +
                                    (e.radius - e.innerRadius) /
                                        (g.gauge_fullCircle ? 1 : 2)) +
                                "px"
                        )
                        .attr("dy", "1.2em")
                ...
                (k.data_selection_enabled &&
                    ((k.zoom_enabled && !j.zoom.altDomain) ||
                        (k.data_selection_multiple &&
                            ...
                            (f = Math.min(b, d)),
                            (g = Math.max(b, d)),
                            (h = k.data_selection_grouped
                                ? j.margin.top
                                : Math.min(c, e)),
                            (i = k.data_selection_grouped
                                ? j.height
                                : Math.max(c, e)),
                            m
                                .select("." + l.dragarea)
            ...
            f.data_selection_enabled &&
                ...
                (f.data_selection_multiple ||
                    d.main
                        ...
                        .each(function (a, b) {
                            var c = e.select(this);
                            c.classed(l.SELECTED) &&
                                i(!1, c.classed(l.SELECTED, !1), a, b);
                        }),
        ...
        (i.initBrush = function () {
            ...
            (a.brush = b.svg.brush().on("brush", function () {
                ...
                (a.brush.update = function () {
                    return (
                        a.context && a.context.select("." + l.brush).call(this),
                        this
                    );
                }),
        ...
        (i.initSubchart = function () {
            ...
            c.style("visibility", d),
                ...
                (a.axes.subx = c
                    ...
                    .style(
                        "visibility",
                        b.subchart_axis_x_show ? d : "hidden"
                    ));
        }),
        ...
        (i.redrawSubchart = function (a, b, c, d, e, f, g) {
            ...
            k.context.style(
                "visibility",
                m.subchart_show ? "visible" : "hidden"
            ),
                m.subchart_show &&
                    (l.event &&
                        "zoom" === l.event.type &&
        ...
        (i.getDefaultExtent = function () {
            ...
            return (
                a.isTimeSeries() &&
                    (c = [a.parseDate(c[0]), a.parseDate(c[1])]),
                c
            );
        }),
        (i.initZoom = function () {
        ...
        (i.redrawForZoom = function () {
            ...
            if (
                ...
                if ("mousemove" === b.event.sourceEvent.type && d.altDomain)
                    return (
                        e.domain(d.altDomain),
                        void d.scale(e).updateScaleExtent()
                    );
                a.isCategorized() &&
                    ...
                    "mousemove" === b.event.sourceEvent.type &&
                        (a.cancelClick = !0),
        ...
        (i.yFormat = function (a) {
            var b = this,
                c = b.config,
                d = c.axis_y_tick_format
                    ? c.axis_y_tick_format
        ...
        (i.getCaches = function (a) {
            ...
            for (b = 0; b < a.length; b++)
                a[b] in this.cache &&
                    c.push(this.cloneTarget(this.cache[a[b]]));
            return c;
        });
    var l = (i.CLASS = {
        target: "c3-target",
    ...
    (i.generateClass = function (a, b) {
        ...
        (i.classArc = function (a) {
            return (
                this.classShape(a.data) + this.generateClass(l.arc, a.data.id)
            );
        }),
        (i.classArcs = function (a) {
            return (
                this.classShapes(a.data) + this.generateClass(l.arcs, a.data.id)
            );
        }),
        ...
        (i.classFocused = function (a) {
            return (
                " " +
                (this.focusedTargetIds.indexOf(a.id) >= 0 ? l.focused : "")
            );
        }),
    ...
    (h.focus = function (a) {
        ...
        (a = c.mapToTargetIds(a)),
            (b = c.svg.selectAll(
                c.selectorTargets(a.filter(c.isTargetToShow, c))
            )),
            this.revert(),
            this.defocus(),
            ...
            return (
                ...
                "cacheIds" in a && b.hasCaches(a.cacheIds)
                    ...
                    : void ("unload" in a
                          ? b.unload(
                                b.mapToTargetIds(
                                    "boolean" == typeof a.unload && a.unload
                                        ? null
                                        : a.unload
                                ),
                                function () {
                        ...
                        if (a.id === b[c].id) {
                            for (
                                ...
                                (b[c].values[d].index = o + d),
                                    j.isTimeSeries() ||
                                        (b[c].values[d].x = o + d);
                            (a.values = a.values.concat(b[c].values)),
                                b.splice(c, 1);
                            break;
                        }
                    e || k.push(a.id);
                        ...
                        i.classed(l.line) ||
                            ...
                            (m && n
                                ...
                                : q(c) &&
                                  c &&
                                  o &&
                                  k(!1, i.classed(l.SELECTED, !1), g, h));
                    });
        }),
        ...
        (h.category = function (a, b) {
            ...
            return (
                arguments.length > 1 &&
                    ((d.axis_x_categories[a] = b), c.redraw()),
        ...
        (h.legend.show = function (a) {
            ...
            b.showLegend(b.mapToTargetIds(a)),
                b.updateAndRedraw({ withLegend: !0 });
        }),
            ...
            a.mouse && (c = a.mouse),
                a.data
                    ? d.isMultipleX()
                        ? ((c = [
                              d.x(a.data.x),
                              d.getYScale(a.data.id)(a.data.value),
                          ]),
                          (b = null))
                        : (b = m(a.data.index)
                              ? a.data.index
                              : d.getIndexByX(a.data.x))
    ...
    (i.isSafari = function () {
        ...
        (function () {
            "SVGPathSeg" in a ||
                ...
                (SVGPathSegClosePath.prototype = Object.create(
                ...
                (SVGPathSegMovetoAbs.prototype = Object.create(
                    SVGPathSeg.prototype
                )),
                ...
                (SVGPathSegMovetoRel.prototype = Object.create(
                    SVGPathSeg.prototype
                )),
                ...
                (SVGPathSegLinetoAbs.prototype = Object.create(
                    SVGPathSeg.prototype
                )),
                ...
                (SVGPathSegLinetoRel.prototype = Object.create(
                    SVGPathSeg.prototype
                )),
                ...
                (SVGPathSegCurvetoCubicAbs.prototype._asPathString =
                    function () {
                        return (
                ...
                (SVGPathSegCurvetoQuadraticAbs.prototype._asPathString =
                    function () {
                        return (
                            this.pathSegTypeAsLetter +
                            " " +
                ...
                (SVGPathSegCurvetoQuadraticRel.prototype.toString =
                    function () {
                        return "[object SVGPathSegCurvetoQuadraticRel]";
                    }),
                (SVGPathSegCurvetoQuadraticRel.prototype._asPathString =
                    function () {
                        return (
                            this.pathSegTypeAsLetter +
                            " " +
                ...
                (SVGPathSegArcAbs.prototype = Object.create(
                    SVGPathSeg.prototype
                )),
                ...
                (SVGPathSegArcRel.prototype = Object.create(
                    SVGPathSeg.prototype
                )),
                ...
                (SVGPathSegLinetoHorizontalAbs.prototype.toString =
                    function () {
                        return "[object SVGPathSegLinetoHorizontalAbs]";
                    }),
                (SVGPathSegLinetoHorizontalAbs.prototype._asPathString =
                    function () {
                ...
                (SVGPathSegLinetoHorizontalRel.prototype.toString =
                    function () {
                        return "[object SVGPathSegLinetoHorizontalRel]";
                    }),
                (SVGPathSegLinetoHorizontalRel.prototype._asPathString =
                    function () {
                        return this.pathSegTypeAsLetter + " " + this._x;
                    }),
                ...
                (SVGPathSegLinetoVerticalAbs.prototype._asPathString =
                    function () {
                ...
                (SVGPathSegLinetoVerticalRel.prototype._asPathString =
                    function () {
                        return this.pathSegTypeAsLetter + " " + this._y;
                    }),
                ...
                (SVGPathSegCurvetoCubicSmoothAbs.prototype.toString =
                    function () {
                        return "[object SVGPathSegCurvetoCubicSmoothAbs]";
                    }),
                (SVGPathSegCurvetoCubicSmoothAbs.prototype._asPathString =
                    function () {
                        return (
                            this.pathSegTypeAsLetter +
                            " " +
                ...
                (SVGPathSegCurvetoCubicSmoothRel.prototype.toString =
                    function () {
                        return "[object SVGPathSegCurvetoCubicSmoothRel]";
                    }),
                (SVGPathSegCurvetoCubicSmoothRel.prototype._asPathString =
                    function () {
                        return (
                            this.pathSegTypeAsLetter +
                            " " +
                ...
                (SVGPathSegCurvetoQuadraticSmoothAbs.prototype.toString =
                    function () {
                ...
                (SVGPathSegCurvetoQuadraticSmoothAbs.prototype.clone =
                    function () {
                ...
                (SVGPathSegCurvetoQuadraticSmoothRel.prototype.toString =
                    function () {
                ...
                (SVGPathSegCurvetoQuadraticSmoothRel.prototype.clone =
                    function () {
                ...
                (SVGPathElement.prototype.createSVGPathSegMovetoAbs = function (
                    a,
                    b
                ) {
                    return new SVGPathSegMovetoAbs(void 0, a, b);
                }),
                (SVGPathElement.prototype.createSVGPathSegMovetoRel = function (
                    a,
                    b
                ) {
                    return new SVGPathSegMovetoRel(void 0, a, b);
                }),
                (SVGPathElement.prototype.createSVGPathSegLinetoAbs = function (
                    a,
                    b
                ) {
                    return new SVGPathSegLinetoAbs(void 0, a, b);
                }),
                (SVGPathElement.prototype.createSVGPathSegLinetoRel = function (
                    a,
                    b
                ) {
                ...
                "SVGPathSegList" in a ||
                    ((a.SVGPathSegList = function (a) {
                        (this._pathElement = a),
                            ...
                            (this._pathElementMutationObserver =
                    ...
                    Object.defineProperty(
                        ...
                        "pathSegList",
                        {
                            get: function () {
                                return (
                                    this._pathSegList ||
                                        (this._pathSegList = new SVGPathSegList(
                                            this
                                        )),
                                    this._pathSegList
                                );
                    ...
                    (SVGPathSegList.prototype.insertItemBefore = function (
                        a,
                        b
                    ) {
                        return (
                    ...
                    (SVGPathSegList.prototype.removeItem = function (a) {
                        ...
                        var b = this._list[a];
                        return (
                            this._list.splice(a, 1), this._writeListToPath(), b
                        );
                    }),
                    ...
                    (SVGPathSegList.prototype._parsePath = function (a) {
                        ...
                        (d.prototype._isCurrentSpace = function () {
                            ...
                            (d.prototype._skipOptionalSpacesOrDelimiter =
                                function () {
                            ...
                            (d.prototype._parseArcFlag = function () {
                                if (!(this._currentIndex >= this._endIndex)) {
                                    ...
                                    return (
                                        this._skipOptionalSpacesOrDelimiter(), a
                                    );
                                }
                            }),
