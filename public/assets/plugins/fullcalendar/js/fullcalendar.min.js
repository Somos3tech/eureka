...
!(function (a) {
    ...
    function q(a) {
        ...
        return (
            r() && "rtl" == a.css("direction") ? (c.left = b) : (c.right = b), c
        );
    }
    function r() {
    ...
    function R(a, b) {
        ...
        return T(a) || T(b)
            ...
            : ((c = a.asMonths()),
              (d = b.asMonths()),
              Math.abs(c) >= 1 && ha(c) && Math.abs(d) >= 1 && ha(d)
                  ? c / d
                  : a.asDays() / b.asDays());
    }
    function S(a, c) {
    ...
    function Ja(a, b) {
        ...
        for (c = 0; c < b.length; c++)
            if (
                ((d = b[c]), d.leftCol <= a.rightCol && d.rightCol >= a.leftCol)
            )
                return !0;
        return !1;
    }
    ...
    function Qa(c, e) {
        ...
        function h() {
            c.addClass("fc"),
                ...
                T.options.handleWindowResize &&
                    ((_ = ja(r, T.options.windowResizeDelay)),
                    a(window).resize(_));
        }
        function i() {
        ...
        function l(b, c) {
            ga++,
                ...
                !Z &&
                    b &&
                    ((Z = T.view = fa[b] || (fa[b] = T.instantiateView(b))),
                    Z.setElement(
                        a("<div class='fc-view fc-" + b + "-view' />").appendTo(
                            W
                        )
                    ),
                    V.activateButton(b)),
                Z &&
                    ((aa = Z.massageCurrentDate(aa)),
                    (Z.displaying &&
                        aa.isWithin(Z.intervalStart, Z.intervalEnd)) ||
                        (k() && (Z.display(aa, c), N(), z(), A(), v()))),
                N(),
                ga--;
        }
        function m() {
        ...
        function q() {
            $ =
                "number" == typeof T.options.contentHeight
                    ...
                    : Math.round(
                          W.width() / Math.max(T.options.aspectRatio, 0.5)
                      );
        }
        function r(a) {
            !ga &&
        ...
        function R(a) {
            ...
            if (1 === c) {
                ...
                if ("businessHours" === b)
                    return void (
                        Z &&
                        (Z.unrenderBusinessHours(), Z.renderBusinessHours())
                    );
                if ("timezone" === b)
        ...
        function S(a, b) {
            ...
            return (
                ...
                T.options[a] ? T.options[a].apply(b, c) : void 0
            );
        }
        var T = this;
        (T.render = g),
        ...
        T.bindOptions(
            ...
            function (a, b, c, d, e, g, h) {
                ...
                "iso" === h && (h = "ISO"),
                    ("ISO" !== h && "local" !== h && "function" != typeof h) ||
                        (U._fullCalendar_weekCalc = h),
                    aa && f(aa);
            }
        ),
            (T.defaultAllDayEventDuration = b.duration(
                T.options.defaultAllDayEventDuration
            )),
            (T.defaultTimedEventDuration = b.duration(
            ...
            (T.moment = function () {
                ...
                return (
                    "local" === T.options.timezone
                        ? ((a = Wa.moment.apply(null, arguments)),
                          a.hasTime() && a.local())
                        : (a =
                              "UTC" === T.options.timezone
            ...
            (T.getNow = function () {
                var a = T.options.now;
                return (
                    "function" == typeof a && (a = a()), T.moment(a).stripZone()
                );
            }),
            ...
            (T.getDefaultEventEnd = function (a, b) {
                ...
                return (
                    a
                        ? c.stripTime().add(T.defaultAllDayEventDuration)
        ...
        var V,
            ...
            ha = [];
        (aa =
            null != T.options.defaultDate
                ? T.moment(T.options.defaultDate).stripZone()
                : T.getNow()),
    ...
    function Ta(b) {
        function c() {
            ...
            (n = c.theme ? "ui" : "fc"),
                f
                    ? (m
                          ? m.empty()
                          : (m = this.el = a("<div class='fc-toolbar'/>")),
                      m
                          .append(e("left"))
                          .append(e("right"))
                          .append(e("center"))
        ...
        function h(a) {
            m &&
                m.find(".fc-" + a + "-button").removeClass(n + "-state-active");
        }
        function i(a) {
            m &&
                m
    ...
    function Ua() {
        ...
        function C(c, d) {
            ...
            if (
                (U.options.eventDataTransform &&
                    (c = U.options.eventDataTransform(c)),
        ...
        function F(a) {
            null == a.allDay &&
                ...
                a.allDay
                    ...
                    : (a.start.hasTime() ||
                          (a.start = U.applyTimezone(a.start.time(0))),
                      a.end &&
                          !a.end.hasTime() &&
                          (a.end = U.applyTimezone(a.end.time(0))));
        }
        function G(b, c, d) {
            var e,
                f,
                ...
                a.each(b, function (b, j) {
                    ...
                    (k = {
                        ...
                        c
                            ...
                            : f &&
                              !l.end &&
                              (l.end = U.getDefaultEventEnd(l.allDay, l.start)),
        ...
        function J(b) {
            var c,
                ...
                f = U.getView();
            return (
                d && (c = a.extend({}, e, "object" == typeof d ? d : {})),
                c
                    ? (b && ((c.start = null), (c.end = null)),
                      G(C(c), f.start, f.end))
                    : []
            );
        }
        ...
        function Q(a, b, c, d) {
            ...
            for (g = U.getPeerEvents(a, d), h = 0; h < g.length; h++)
                if (((i = g[h]), T(i, a))) {
                    ...
                    if (d) {
                        if (
                            ((j = ba(i.overlap, (i.source || {}).overlap)),
                            j === !1)
                        )
                            return !1;
    ...
    var lb = (Wa.EmitterMixin = {
                ...
                c = {
                    ...
                    listenTo: function (b, c, d) {
                        if ("object" == typeof c)
                            for (var e in c)
                                c.hasOwnProperty(e) &&
                                    this.listenTo(b, e, c[e]);
                        else
                            "string" == typeof c &&
                                b.on(
                                    c + "." + this.getListenerNamespace(),
                                    a.proxy(d, this)
                                );
                    },
        ...
        nb = {
            ...
            initMouseIgnoring: function (a) {
                this.delayUnignoreMouse = ja(
                    ia(this, "unignoreMouse"),
                    a || 1e3
                );
            },
        ...
        qb = (Wa.DragListener = ya.extend(mb, nb, {
            ...
            constructor: function (a) {
                (this.options = a || {}),
                    (this.handleTouchScrollProxy = ia(
                        this,
                        "handleTouchScroll"
                    )),
            ...
            startDrag: function (a, b) {
                this.startInteraction(a, b),
                    this.isDragging ||
                        ((this.isDragging = !0), this.handleDragStart(a));
            },
            ...
            endDrag: function (a) {
                this.isDragging &&
                    ((this.isDragging = !1), this.handleDragEnd(a));
            },
            ...
            initHrefHack: function () {
                ...
                (this.subjectHref = a ? a.attr("href") : null) &&
                    a.removeAttr("href");
            },
    ...
    qb.mixin({
            ...
            (this.isAutoScroll =
                ...
                this.isAutoScroll &&
                    this.listenTo(
                        a,
                        "scroll",
                        ja(this.handleDebouncedScroll, 100)
                    );
        },
        ...
        scrollIntervalFunc: function () {
            ...
            this.scrollTopVel &&
                a.scrollTop(a.scrollTop() + this.scrollTopVel * b),
                this.scrollLeftVel &&
    ...
    var rb = qb.extend({
                    ...
                    a
                        ? ((c = { left: v(a), top: w(a) }),
                          ...
                          e &&
                              ...
                              (this.origHit && (b = C(this.origHit, b) || b),
                              (d = E(b))),
        ...
        tb = (Wa.Grid = ya.extend(mb, nb, {
            ...
            computeSelection: function (a, b) {
                ...
                return c && !this.view.calendar.isSelectionSpanAllowed(c)
                    ? !1
                    : c;
            },
                ...
                if (c.length) {
                    ...
                    a(g).each(function (b, d) {
                        ...
                        f && (i = f.call(e, g, i)),
                            i &&
                                ((i = a(i)),
                                i.is(e.fillSegTag) && ((g.el = i), h.push(g)));
                    });
                }
                return h;
            },
    ...
    tb.mixin({
        ...
        handleSegMousedown: function (a, b) {
            ...
            !c &&
                ...
                this.buildSegDragListener(a).startInteraction(b, {
                    distance: 5,
                });
        },
            ...
            f.opt("droppable") &&
                ...
                (a.isFunction(e) ? e.call(d[0], d) : d.is(e)) &&
                    (this.isDraggingExternal ||
                        this.listenToExternalDrag(d, b, c)));
        },
                ...
                j = (e.externalDragListener = new rb(this, {
                    ...
                    hitOver: function (a) {
                        (d = e.computeExternalDrop(
                            a.component.getHitSpan(a),
                            i
                        )),
                            d &&
                                !f.isExternalSpanAllowed(
                                    e.eventToSpan(d),
                                    d,
                                    i.eventProps
                                ) &&
            ...
            spanToSegs: function (a) {
                ...
                for (b = 0; b < d.length; b++)
                    (c = d[b]),
                        this.isRTL
                            ? ((c.leftCol =
                                  this.daysPerRow - 1 - c.lastRowDayIndex),
                              (c.rightCol =
                                  this.daysPerRow - 1 - c.firstRowDayIndex))
    ...
    vb.mixin({
        ...
        getEventSegs: function () {
            return tb.prototype.getEventSegs
                .call(this)
                ...
                for (; b > g; )
                    (k = (r[e - 1] || [])[g]),
                        k
                            ? k.attr(
                                  "rowspan",
                                  parseInt(k.attr("rowspan") || 1, 10) + 1
                              )
                            : ((k = a("<td/>")), h.append(k)),
                        (q[e][g] = k),
                        (r[e][g] = k),
        ...
        vb.mixin({
                    ...
                    for (
                        ...
                        if (k) {
                            for (
                                ...
                                (q = a('<td class="fc-more-cell"/>').attr(
                                    "rowspan",
                                    n
                                )),
                                    (j = l[p]),
                                    (s = this.renderMoreLink(
                                        b,
                                        i.leftCol + p,
                                        [i].concat(j)
                                    )),
            ...
            unlimitRow: function (a) {
                ...
                b.moreEls && (b.moreEls.remove(), (b.moreEls = null)),
                    b.limitedEls &&
                        (b.limitedEls.removeClass("fc-limited"),
                        (b.limitedEls = null));
            },
            ...
            renderSegPopoverContent: function (b, c, d) {
                var e,
                    f = this.view,
                    g = f.opt("theme"),
                    h = this.getCellDate(b, c).format(
                        f.opt("dayPopoverFormat")
                    ),
                    i = a(
                        '<div class="fc-header ' +
                            f.widgetHeaderClass +
    ...
    wb.mixin({
        ...
        renderContentSkeleton: function () {
            ...
            (c = a(
                ...
                (this.highlightContainerEls = c.find(
        ...
        renderHelperSegs: function (b, c) {
            var d,
                ...
                g = [];
            for (
                b = this.renderFgSegsIntoContainers(b, this.helperContainerEls),
                    d = 0;
                d < b.length;
                d++
            )
            ...
            if (void 0 === a.forwardCoord)
                for (
                    e.length
                        ...
                        : (a.forwardCoord = 1),
                        a.backwardCoord =
                            a.forwardCoord - (a.forwardCoord - c) / (b + 1),
                        d = 0;
                    d < e.length;
                    d++
                )
    ...
    var xb = (Wa.View = ya.extend(lb, mb, {
            ...
            constructor: function (a, c, d, e) {
                (this.calendar = a),
                    ...
                    (this.nextDayThreshold = b.duration(
            ...
            renderedEventSegEach: function (a, b) {
                var c,
                    d = this.getEventSegs();
                for (c = 0; c < d.length; c++)
                    (b && d[c].event._id !== b._id) ||
                        (d[c].el && a.call(this, d[c]));
            },
            getEventSegs: function () {
                return [];
            },
            ...
            processEventUnselect: function (b) {
                this.selectedEvent &&
                    (a(b.target).closest(".fc-selected").length ||
                        this.unselectEvent());
            },
            ...
            initHiddenDays: function () {
                var b,
                    ...
                    e = 0;
                for (
                    this.opt("weekends") === !1 && c.push(0, 6), b = 0;
                    7 > b;
                    b++
                )
        ...
        zb = (Wa.Calendar = ya.extend({
            ...
            buildViewSpecButtonText: function (a, b) {
                ...
                (a.buttonTextOverride =
                    c(this.dynamicOverrides) ||
                    c(this.overrides) ||
                    a.overrides.buttonText),
                    (a.buttonTextDefault =
                        c(this.langDefaults) ||
                        c(this.dirDefaults) ||
            ...
            pushLoading: function () {
                this.loadingLevel++ ||
                    this.trigger("loading", null, !0, this.view);
            },
            popLoading: function () {
                --this.loadingLevel ||
                    this.trigger("loading", null, !1, this.view);
            },
    ...
    zb.mixin(lb),
        zb.mixin({
            ...
            registerOptionHandlerObj: function (a, b) {
                (this.optionHandlers[a] || (this.optionHandlers[a] = [])).push(
                    b
                );
            },
    ...
    var Jb = (Wa.AgendaView = xb.extend({
            ...
            setHeight: function (a, b) {
                ...
                this.bottomRuleEl.hide(),
                    ...
                    b ||
                        ...
                        this.timeGrid.getTotalSlatHeight() < d &&
            ...
            queryHit: function (a, b) {
                ...
                return (
                    !c && this.dayGrid && (c = this.dayGrid.queryHit(a, b)), c
                );
            },
            getHitSpan: function (a) {
