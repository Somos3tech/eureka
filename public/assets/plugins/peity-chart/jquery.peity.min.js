...
(function (k, w, h, v) {
    var d = (k.fn.peity = function (a, b) {
                ...
                this.each(function () {
                    ...
                    c
                        ...
                        : ((c = new x(
                              e,
                              a,
                              k.extend({}, d.defaults[a], e.data("peity"), b)
                          )),
                          e
                              .change(function () {
                                  c.draw();
        ...
        q = (o.svgElement = function (a, b) {
            return k(w.createElementNS("http://www.w3.org/2000/svg", a)).attr(
                b
            );
        }),
    ...
    o.prepare = function (a, b) {
        this.$svg ||
            this.$el.hide().after((this.$svg = q("svg", { class: "peity" })));
        return this.$svg
            .empty()
            .data("peity", this)
    ...
    d.register(
        ...
        function (a) {
            ...
            g.push(f, s);
            a.fill &&
                d.append(q("polygon", { fill: a.fill, points: g.join(" ") }));
            l &&
                d.append(
                    q("polyline", {
                        fill: "none",
