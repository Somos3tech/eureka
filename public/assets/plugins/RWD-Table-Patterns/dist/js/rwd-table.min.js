...
!(function (a) {
    ...
    (e.DEFAULTS = {
        ...
        (e.prototype.displayAll = function (b, c) {
            this.$displayAllBtn &&
                this.$displayAllBtn.toggleClass("btn-primary", b),
                this.$table.toggleClass("display-all", b),
                this.$tableClone &&
                    this.$tableClone.toggleClass("display-all", b),
        ...
        (e.prototype.preserveDisplayAll = function () {
            ...
            a("html").hasClass("lt-ie9") && (b = "inline"),
                ...
                this.$tableClone &&
                    a(this.$tableClone).find("th, td").css("display", b);
        }),
        (e.prototype.createStickyTableHeader = function () {
            ...
            (b.$tableClone = b.$table.clone()),
                ...
                a("html").hasClass("lt-ie10")
                    ? b.$tableWrapper.prepend(b.$stickyTableHeader)
        ...
        (e.prototype.updateStickyTableHeader = function () {
            ...
            if (h) {
                if (
                    (b.$stickyTableHeader.scrollLeft(
                        b.$tableScrollWrapper.scrollLeft()
                    ),
                        ...
                        g
                            ...
                            .change(function () {
                                ...
                                b.$table.hasClass("display-all") &&
                                    ...
                                    b.$tableClone &&
                                        b.$tableClone.removeClass(
                                            "display-all"
                                        ),
                                    b.$displayAllBtn.removeClass(
                                        "btn-primary"
                                    )),
                                    e.each(function () {
                                        var b = a(this);
                ...
                a(this)
                    ...
                    .each(function () {
                        for (
                            ...
                            e = e + " " + b.idPrefix + h;
                            var i = b.$tableScrollWrapper.find(
                                    "#" + b.idPrefix + h
                                ),
    ...
    (a.fn.responsiveTable = function (b) {
        return this.each(function () {
            ...
            "" !== f.pattern &&
                (d || c.data("responsiveTable", (d = new e(this, f))),
                "string" == typeof b && d[b]());
        });
    }),
