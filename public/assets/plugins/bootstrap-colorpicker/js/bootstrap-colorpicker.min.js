...
!(function (a, b) {
    ...
    var b = function (c, d, e, f, g) {
        (this.fallbackValue = e
            ? e && "undefined" != typeof e.h
                ? e
        ...
        (b.prototype = {
            ...
            toAlias: function (a, b, c, d) {
                ...
                for (var h in this.colors)
                    if (
                        ((e = this.colors[h].toLowerCase().trim()),
                        e === f || e === g)
                    )
                        return h;
                return !1;
                        ...
                        return (
                            ...
                            !c ||
                                ...
                                (d = g
                                    ...
                                    : h.format
                                    ? h.format
                                    : e.getValidFallbackFormat()),
                                (f = d.match(/hsla?/)
                                    ? e.RGBtoHSB.apply(
                                          e,
                                          e.HSLtoRGB.apply(e, c)
                                      )
                                    : e.RGBtoHSB.apply(e, c)),
            ...
            getValidFallbackFormat: function () {
                ...
                return this.origFormat && a.indexOf(this.origFormat) !== -1
                    ? this.origFormat
                    : this.fallbackFormat &&
                      a.indexOf(this.fallbackFormat) !== -1
                    ? this.fallbackFormat
                    : "rgba";
            },
        ...
        d = function (b, d) {
            ...
            if (
                ...
                "right" === this.options.align &&
                    e.addClass("colorpicker-right"),
                this.options.inline === !0 &&
                    e.addClass("colorpicker-no-arrow"),
            ...
            hide: function (b) {
                return (
                    ("undefined" == typeof b ||
                        !b.target ||
                        !(
                            a(b.currentTarget).parents(".colorpicker").length >
                                0 ||
                ...
                if (0 !== c.length)
                    return (
                        this.options.horizontal === !1
                            ? ((b = this.options.sliders),
                              c
                                  ...
                                  .css(
                                      "top",
                                      b.hue.maxTop * (1 - this.color.value.h)
                                  )
                                  .end()
                                  .eq(2)
                                  .css(
                                      "top",
                                      b.alpha.maxTop * (1 - this.color.value.a)
                                  ))
                            : ((b = this.options.slidersHorz),
                              c
                                  ...
                                  .css(
                                      "left",
                                      b.hue.maxLeft * (1 - this.color.value.h)
                                  )
                                  .end()
                                  .eq(2)
                                  .css(
                                      "left",
                                      b.alpha.maxLeft * (1 - this.color.value.a)
                                  )),
                        c.eq(0).css({
                            top:
                                b.saturation.maxTop -
                                this.color.value.b * b.saturation.maxTop,
                        ...
                        this.picker
                            ...
                            .css(
                                "backgroundColor",
                                this.color.toString(!0, this.format)
                            ),
                        a
                    );
            },
                ...
                var b = Math.max(
                        ...
                        Math.min(
                            ...
                            this.currentSlider.left +
                                ((a.pageX || this.mousePointer.left) -
            ...
            keyup: function (a) {
                38 === a.keyCode
                    ? (this.color.value.a < 1 &&
                          (this.color.value.a =
                              Math.round(100 * (this.color.value.a + 0.01)) /
                              100),
                      this.update(!0))
                    : 40 === a.keyCode
