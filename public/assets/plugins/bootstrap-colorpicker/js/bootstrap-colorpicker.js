...
(function (root, factory) {
    ...
    Color.prototype = {
        ...
        isTransparent: function (strVal) {
            if (
                !strVal ||
                !(typeof strVal === "string" || strVal instanceof String)
            ) {
                return false;
            }
        ...
        toAlias: function (r, g, b, a) {
            var c,
                rgb =
                    arguments.length === 0
                        ? this.toHex(true)
                        : this.toHex(true, r, g, b, a);

            // support predef. colors in non-hex format too, as defined in the alias itself
            var original =
                this.origFormat === "alias"
                    ? rgb
                    : this.toString(false, this.origFormat);
        ...
        getValidFallbackFormat: function () {
            ...
            if (
                this.fallbackFormat &&
                formats.indexOf(this.fallbackFormat) !== -1
            ) {
    ...
    var Colorpicker = function (element, options) {
        ...
        if (this.options.colorSelectors) {
            var colorpicker = this,
                selectorsContainer = colorpicker.picker.find(
        ...
        updatePicker: function (val) {
            ...
            icns.eq(0).css({
                top:
                    ...
                    this.color.value.b * sl.saturation.maxTop,
            ...
            this.picker
                ...
                .css(
                    "backgroundColor",
                    this.color.toHex(true, this.color.value.h, 1, 1, 1)
                );
