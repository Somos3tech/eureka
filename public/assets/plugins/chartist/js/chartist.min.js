...
!(function (a, b) {
    ...
    return (
        (function (a, b, c) {
            ...
            (c.namespaces = {
                ...
                (c.getDataArray = function (a, b, d) {
                    function e(a) {
                        if (!c.isFalseyButZero(a)) {
                            if ((a.data || a) instanceof Array)
                                return (a.data || a).map(e);
                ...
                (c.getBounds = function (a, b, d, e) {
                    ...
                    else if (e && m < j.step && c.projectLength(a, m, j) >= d)
                        j.step = m;
                    else
                        for (;;) {
                            if (l && c.projectLength(a, j.step, j) <= d)
                                j.step *= 2;
                            else {
                                if (
                                    l ||
                                    !(c.projectLength(a, j.step / 2, j) >= d)
                                )
                                    break;
        ...
        (function (a, b, c) {
            ...
            (c.Svg.Easing = y),
                (c.Svg.List = c.Class.extend({ constructor: x }));
        })(window, document, a),
        (function (a, b, c) {
            "use strict";
                ...
                (k =
                    ...
                    a.horizontalBars
                        ? ((j = m =
                          ...
                          (l = n =
                              void 0 === a.axisY.type
                                  ? new c.StepAxis(c.Axis.units.y, d, o, {
                                        ticks: k,
                                    })
                                  : a.axisY.type.call(
                                        c,
                        ...
                        : ((l = m =
                              void 0 === a.axisX.type
                                  ? new c.StepAxis(c.Axis.units.x, d, o, {
                                        ticks: k,
                                    })
                                  : a.axisX.type.call(
                                        c,
                ...
                for (var p = 0; p < this.data.series.length; p++)
                    if (0 !== l[p] || !a.ignoreEmptyValues) {
                        ...
                        var w = j[p].elem(
                            ...
                            { d: v.stringify() },
                            a.donut
                                ? a.classNames.sliceDonut
                                : a.classNames.slicePie
                        );
                        if (
                            (w.attr({
                                "ct:value": l[p],
                            ...
                            var x = c.polarToCartesian(
                                ...
                                y = a.labelInterpolationFnc(
                                    this.data.labels &&
                                        !c.isFalseyButZero(this.data.labels[p])
                                        ? this.data.labels[p]
                                        : l[p],
                                    p
                                );
