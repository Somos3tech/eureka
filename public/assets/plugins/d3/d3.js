        ...
        return function (specifier) {
            ...
            return function (value) {
                ...
                var length =
                    ...
                    padding =
                        length < width
                            ? new Array((length = width - length + 1)).join(
                                  fill
                              )
                            : "";
                if (zcomma)
        ...
        for (var i = 0, n = polygon.length; i < n; ++i) {
            ...
            while (true) {
                ...
                if (antimeridian ^ (λ0 >= meridian) ^ (λ >= meridian)) {
                    ...
                    var intersection = d3_geo_cartesianCross(
                        meridianNormal,
                        arc
                    );
        ...
        while (true) {
            ...
            if (
                ...
                if (site.x !== x0 || site.y !== y0) {
                    d3_geom_voronoiCells[site.i] = new d3_geom_voronoiCell(
                        site
                    );
        ...
        function hierarchy(root) {
            ...
            while ((node = stack.pop()) != null) {
                ...
                if (
                    ...
                    if (value)
                        node.value =
                            +value.call(hierarchy, node, node.depth) || 0;
            ...
            d3_layout_hierarchyVisitAfter(
                ...
                nodeSize
                    ...
                    : function (node) {
                          ...
                          node.y =
                              (1 - (root.y ? node.y / root.y : 1)) * size[1];
                      }
            );
            return nodes;
        }
            ...
            d3.timer(
                function (elapsed) {
                    ...
                    function start(elapsed) {
                        ...
                        lock.active = id;
                        transition.event &&
                            transition.event.start.call(node, d, i);
                    ...
                    function stop(end) {
                        if (transition.event)
                            transition.event[end ? "end" : "interrupt"].call(
                                node,
                                d,
                                i
                            );
