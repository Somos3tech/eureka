!(function () {
    ...
    function Lt() {
        var n = Tt(),
            t = Rt() - n;
        t > 24
            ? (isFinite(t) && (clearTimeout(ic), (ic = setTimeout(Lt, t))),
              (uc = 0))
            : ((uc = 1), ac(Lt));
    }
    function Tt() {
    ...
    function pr(n, t) {
        ...
        return function (u, i, o, a) {
            ...
            for (var l, s = u; o > 0 ? s > i : i > s; s -= c)
                a.point(
                    (l = be([e, -r * Math.cos(s), -r * Math.sin(s)]))[0],
                    l[1]
                );
        };
    }
    ...
    function ou(n, t) {
        var e,
            ...
            i = n.sort(au).pop();
        for (
            tl = [], el = new Array(n.length), rl = new tu(), il = new tu();
            ;

        )
            if (
                ((u = ul), i && (!u || i.y < u.y || (i.y === u.y && i.x < u.x)))
            )
                (i.x !== e || i.y !== r) &&
    ...
    function zu(n, t) {
        ...
        return (
            ...
            function (r) {
                return (
                    1 + n * Math.pow(2, -10 * r) * Math.sin(((r - e) * Pa) / t)
                );
            }
        );
    }
    ...
    function bo(n, t) {
        return n.length < 3
            ...
            : n[0] +
                  wo(
                      (n.push(n[0]), n),
                      So([n[n.length - 2]].concat(n, [n[1]]), t)
                  );
    }
    function _o(n, t) {
    ...
    function To(n) {
        for (
            var t, e, r, u, i = [], o = Lo(n), a = -1, c = n.length - 1;
            ++a < c;
    ...
    (ta.bisectLeft = pa.left),
        ...
        (ta.zip = function () {
            ...
            for (
                var n = -1, t = ta.min(arguments, u), e = new Array(t);
                ++n < t;
    ...
    (ta.selection.enter = O),
        ...
        (Aa.insert = function (n, t) {
            return (
                arguments.length < 2 && (t = Y(this)),
                ka.insert.call(this, n, t)
            );
        }),
    ...
    (ta.interpolateZoom = function (n, t) {
        ...
        (ta.behavior.zoom = function () {
            ...
            function s() {
                ...
                function e() {
                    f.on(q, null).on(L, null),
                        g(s && ta.event.target === i),
                        l(o);
                }
                var r = this,
                    i = ta.event.target,
            ...
            function f() {
                ...
                function e() {
                    ...
                    for (
                        var e = ta.event.changedTouches, r = 0, u = e.length;
                        u > r;
                        ++r
                    )
        ...
        [
            ...
            var e = (fc[n] = Ht(
                ...
                function (n) {
                    ...
                    return (
                        Math.floor((fc.dayOfYear(n) + ((e + t) % 7)) / 7) -
                        (e !== t)
                    );
                }
            ));
    ...
    (ta.geo.path = function () {
        ...
        (ta.geo.rotation = function (n) {
            function t(t) {
                return (
                    (t = n(t[0] * Fa, t[1] * Fa)), (t[0] *= Ha), (t[1] *= Ha), t
                );
            }
            return (
                (n = sr(
        ...
        (ta.layout.force = function () {
            ...
            return (
                (a.tick = function () {
                    ...
                    for (e = 0; _ > e; ++e)
                        (a = y[e]),
                            ...
                            (p = M * M + x * x) &&
                                ...
                                (x *= p),
                                (h.x -=
                                    M * (d = f.weight / (h.weight + f.weight))),
                                (h.y -= x * d),
                                (f.x += M * (d = 1 - d)),
                                (f.y += x * d));
                    if (
                        (d = r * v) &&
                        ((M = l[0] / 2), (x = l[1] / 2), (e = -1), d)
                    )
                        for (; ++e < b; )
                            (a = m[e]),
                                (a.x += (M - a.x) * d),
                    ...
                    if (g)
                        for (
                            Gu((t = ta.geom.quadtree(m)), r, o), e = -1;
                            ++e < b;
    ...
    ta.svg.brush = function () {
        ...
        function u() {
            ...
            function v() {
                ...
                M && ((n[0] += M[0]), (n[1] += M[1])),
                    ...
                    u &&
                        (t(S),
                        w({ type: "brush", mode: N ? "move" : "resize" }));
            }
            function d(n, t, e) {
                var r,
                    u,
        ...
        return (
            ...
            (n.clear = function () {
                return (
                    n.empty() || ((s = [0, 0]), (f = [0, 0]), (i = o = null)), n
                );
            }),
            (n.empty = function () {
