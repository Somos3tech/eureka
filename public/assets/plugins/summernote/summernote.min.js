    ...
    var agent = {
        ...
        dom = (function () {
            var a = function (a) {
                ...
                z =
                    agent.isMSIE && agent.browserVersion < 11
                        ? "&nbsp;"
                        : "<br>",
                A = function (a) {
                    return d(a)
                ...
                X = function (b, c) {
                    ...
                    if (0 === b.offset) {
                        ...
                        W(b.node)
                            ? ((d = b.node.childNodes[b.offset - 1]),
                              (e = A(d)))
    ...
    var Renderer = function (a, b, c, d) {
        ...
        button = renderer.create(
            ...
            function (a, b) {
                b &&
                    b.tooltip &&
                    a.attr({ title: b.tooltip }).tooltip({
                        container: "body",
                        trigger: "hover",
                        placement: "bottom",
                    });
        ...
        palette = renderer.create(
            ...
            function (a, b) {
                for (var c = [], d = 0, e = b.colors.length; e > d; d++) {
                    ...
                    c.push(
                        '<div class="note-color-row">' + h.join("") + "</div>"
                    );
                }
                a.html(c.join("")),
        ...
        popover = renderer.create(
            ...
            function (a, b) {
                var c =
                    "undefined" != typeof b.direction ? b.direction : "bottom";
        ...
        range = (function () {
                            ...
                            var a = function (a, b) {
                                    if (
                                        (dom.isVisiblePoint(a) &&
                                            !dom.isEdgePoint(a)) ||
                                        (dom.isVisiblePoint(a) &&
                                            dom.isRightEdgePoint(a) &&
                                            !b) ||
                                        (dom.isVisiblePoint(a) &&
                                            dom.isLeftEdgePoint(a) &&
                                            b) ||
                                        (dom.isVisiblePoint(a) &&
                                            dom.isBlock(a.node) &&
                                            dom.isEmpty(a.node))
                                    ...
                                    if (
                                        ((dom.isLeftEdgePointOf(a, c) ||
                                            dom.isVoid(
                                                dom.prevPoint(a).node
                                            )) &&
                                            !b) ||
                                        ((dom.isRightEdgePointOf(a, c) ||
                                            dom.isVoid(
                                                dom.nextPoint(a).node
                                            )) &&
                                            b)
                                    ) {
                    ...
                    (this.isOnEditable = h(dom.isEditable)),
                        ...
                        (this.paraBookmark = function (b) {
                            return {
                                s: {
                                    path: list.tail(
                                        dom.makeOffsetPath(list.head(b), a)
                                    ),
                                    offset: d,
                                },
                                e: {
                                    path: list.tail(
                                        dom.makeOffsetPath(list.last(b), e)
                                    ),
                                    offset: f,
                                },
                            };
            ...
            return {
                ...
                createFromNode: function (a) {
                    ...
                    return (
                        dom.isVoid(b) &&
                            ((c = dom.listPrev(b).length - 1),
                            (b = b.parentNode)),
                        dom.isBR(d)
                            ? ((e = dom.listPrev(d).length - 1),
                              (d = d.parentNode))
                            : dom.isVoid(d) &&
                              ((e = dom.listPrev(d).length),
                              (d = d.parentNode)),
                        this.create(b, c, d, e)
                    );
                },
        ...
        Style = function () {
            ...
            (this.fromNode = function (b) {
                ...
                (this.stylePara = function (a, b) {
                    $.each(
                        a.nodes(dom.isPara, { includeAncestor: !0 }),
                        function (a, c) {
                            $(c).css(b);
                        }
                    );
                ...
                (this.styleNodes = function (a, b) {
                    ...
                    var f = dom.makePredByNodeName(c),
                        g = a
                            .nodes(dom.isText, { fullyContains: !0 })
                            .map(function (a) {
                                return (
                                    dom.singleChildAncestor(a, f) ||
                                    dom.wrap(a, c)
                                );
                            });
                    if (d) {
                ...
                (this.current = function (a) {
                    ...
                    if (g && g.style["line-height"])
                        ...
                        var h =
                            parseInt(c["line-height"], 10) /
                            parseInt(c["font-size"], 10);
                        c["line-height"] = h.toFixed(1);
                    }
                    return (
                        (c.anchor =
                            a.isOnAnchor() && dom.ancestor(a.sc, dom.isAnchor)),
            ...
            (this.insertOrderedList = function (a) {
                ...
                (this.wrapList = function (a, b) {
                    ...
                    return (
                        ...
                        f &&
                            (dom.appendChildNodes(g, list.from(f.childNodes)),
                            dom.remove(f)),
                        a
                    );
                }),
                (this.releaseList = function (a, b) {
                    ...
                    return (
                        $.each(a, function (a, d) {
                            ...
                            $.each(j, function (a, b) {
                                var c = [b].concat(
                                    dom.listDescendant(b, dom.isList)
                                );
                ...
                (this.insertParagraph = function (b) {
                    ...
                    if (e) {
                        ...
                        if (
                            ...
                            (f = f.concat(
                                dom.listDescendant(d, dom.isEmptyAnchor)
                            )),
                                $.each(f, function (a, b) {
                                    dom.remove(b);
                                }),
        ...
        Table = function () {
            (this.tab = function (a, b) {
                ...
                (this.createTable = function (a, b, c) {
                    ...
                    var j = $("<table>" + g + "</table>");
                    return (
                        c && c.tableClassName && j.addClass(c.tableClassName),
                        j[0]
                    );
                });
        },
        ...
        Editor = function (a) {
            ...
            (this.initialize = function () {
                e
                    .on("keydown", function (c) {
                        c.keyCode === key.code.ENTER &&
                            a.triggerEvent("enter", c),
            ...
            (this.tab = function () {
                ...
                (this.insertImages = function (c) {
                    $.each(c, function (c, d) {
                        var e = d.name;
                        f.maximumImageFileSize &&
                        f.maximumImageFileSize < d.size
                            ? a.triggerEvent(
                                  "image.upload.error",
                ...
                (this.getSelectedText = function () {
                    ...
                    return (
                        a.isOnAnchor() &&
                            (a = range.createFromNode(
                                dom.ancestor(a.sc, dom.isAnchor)
                            )),
                        a.toString()
                    );
                }),
            ...
            (this.fontSize = function (a) {
                ...
                if (b && b.isCollapsed()) {
                    ...
                    o(), $(j.styleNodes(b)).css({ "font-size": a + "px" }), p();
            }),
                (this.insertHorizontalRule = this.wrapCommand(function () {
                    var a = this.createRange().insertNode(dom.create("HR"));
                    a.nextSibling &&
                        range.create(a.nextSibling, 0).normalize().select();
                })),
                a.memo(
                    "help.insertHorizontalRule",
                    g.help.insertHorizontalRule
                ),
        ...
        Clipboard = function (a) {
            ...
            (this.events = {
                ...
                (this.needKeydownHook = function () {
                    return (
                        (agent.isMSIE && agent.browserVersion > 10) ||
                        agent.isFF
                    );
                }),
                (this.initialize = function () {
                ...
                (this.pasteByEvent = function (b) {
                    ...
                    if (c && c.items && c.items.length) {
                        ...
                        "file" === d.kind &&
                            ...
                            a.invoke("editor.insertImagesOrCallback", [
                                d.getAsFile(),
                            ]),
                ...
                (this.activate = function () {
                    if (
                        ...
                        if (e.codemirror.tern) {
                            var g = new CodeMirror.TernServer(
                                e.codemirror.tern
                            );
                            (f.ternServer = g),
                ...
                e.airMode ||
                    ...
                    c.on("mousedown", function (a) {
                        ...
                        b.on("mousemove", function (a) {
                            ...
                            (b =
                                e.minheight > 0 ? Math.max(b, e.minheight) : b),
                                (b =
                                    e.maxHeight > 0
            ...
            (this.toggle = function () {
                var h = function (a) {
                    d.css("height", a.h),
                        e.css("height", a.h),
                        e.data("cmeditor") &&
                            e.data("cmeditor").setsize(null, a.h);
                };
        ...
        Placeholder = function (a) {
            ...
            (this.events = {
                ...
                (this.update = function () {
                    var b =
                        !a.invoke("codeview.isActivated") &&
                        a.invoke("editor.isEmpty");
                                ...
                                c.dropdown({
                                    ...
                                    template: function (a) {
                                        "string" == typeof a &&
                                            (a = {
                                                tag: a,
                                                title: f.style.hasOwnProperty(a)
                                                    ? f.style[a]
                                                    : a,
                                            });
                                        var b = a.tag,
                                ...
                                .buttonGroup(
                                    ...
                                    ],
                                    {
                                        callback: function (c) {
                                            ...
                                            d.css({
                                                width:
                                                    e.insertTableMaxSize.col +
                                                    "em",
                                                height:
                                                    e.insertTableMaxSize.row +
                                                    "em",
                                            })
                                                .mousedown(
                        ...
                        a.memo("button.hr", function () {
                            return c
                                .button({
                                    ...
                                    tooltip:
                                        f.hr.insert + h("insertHorizontalRule"),
                                    click: a.createInvokeHandler(
        ...
        LinkDialog = function (a) {
            ...
            (this.initialize = function () {
                ...
                a.memo(
                    ...
                    e.langInfo.help["linkDialog.show"]
                );
        },
        ...
        ImageDialog = function (a) {
            ...
            (this.initialize = function () {
                ...
                if (e.maximumImageFileSize) {
                    var g = Math.floor(
                            Math.log(e.maximumImageFileSize) / Math.log(1024)
                        ),
                        h =
                            1 *
                                (
                                    e.maximumImageFileSize / Math.pow(1024, g)
                                ).toFixed(2) +
                            " " +
                            " KMGTP"[g] +
                            "B";
                ...
                (this.createVideoNode = function (a) {
                    ...
                    if (d && 11 === d[1].length) {
                        ...
                        b = $("<iframe>")
                            ...
                            .attr(
                                "src",
                                "https://instagram.com/p/" + f[1] + "/embed/"
                            )
                            .attr("width", "612")
                            .attr("height", "710")
                            .attr("scrolling", "no")
                        ...
                        b = $("<iframe>")
                            ...
                            .attr(
                                "src",
                                "//www.dailymotion.com/embed/video/" + l[2]
                            )
                            .attr("width", "640")
                            .attr("height", "360");
                    ...
                    .map(function (c) {
                        ...
                        return (
                            e
                                .append(
                                    $(
                                        "<label><kbd>" + c + "</kdb></label>"
                                    ).css({ width: 180, "margin-right": 10 })
                                )
                                .append(
                                    $("<span/>").html(a.memo("help." + d) || d)
                                ),
                            e.html()
                        );
                    })
                ...
                (this.createGroup = function (a, c) {
                    ...
                    return (
                        this.searchKeyword(a, c, function (c) {
                            (c = c || []),
                                c.length &&
                                    (d.html(b.createItemTemplates(a, c)),
                                    b.show());
                        }),
                        d
                    );
