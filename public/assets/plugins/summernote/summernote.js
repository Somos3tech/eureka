...
(function (factory) {
    ...
    var dom = (function () {
        ...
        var isVoid = function (node) {
            return (
                node &&
                /^BR|^IMG|^HR|^IFRAME|^BUTTON/.test(node.nodeName.toUpperCase())
            );
        };
        ...
        return {
            ...
            isEdit: function (keyCode) {
                return list.contains(
                    [keyMap.BACKSPACE, keyMap.TAB, keyMap.ENTER, keyMap.SPACE],
                    keyCode
                );
            },
            /**
        ...
        this.insertParagraph = function (editable) {
            ...
            if (splitRoot) {
                ...
                if (dom.isEmpty(splitRoot) && dom.isLi(splitRoot)) {
                    ...
                    if (
                        (dom.isHeading(nextPara) || dom.isPre(nextPara)) &&
                    ...
                    .buttonGroup([
                        ui.button({
                            ...
                            contents:
                                ...
                                " " +
                                ui.icon(options.icons.caret, "span"),
