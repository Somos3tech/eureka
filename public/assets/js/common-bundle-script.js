                        ...
                        (e.pause = function (e) {
                            e || (this._isPaused = !0),
                                this._element.querySelector(ee) &&
                                    (we.triggerTransitionEnd(this._element),
                                    this.cycle(!0)),
                            ...
                            if (
                                ...
                                if (k(this._element).hasClass(Y)) {
                                    k(l).addClass(i),
                                        ...
                                        k(l).addClass(n);
                                    var h =
                                        we.getTransitionDurationFromElement(s);
                                    k(s)
                    ...
                    return (
                        ...
                        (e.show = function () {
                            ...
                            if (
                                ...
                                if (
                                    (oe(this._element).trigger(i),
                                    !i.isDefaultPrevented())
                                ) {
                                    e &&
                                        (a._jQueryInterface.call(
                                            oe(e).not(this._selector),
                                            "hide"
                                        ),
                                        t || oe(e).data(ae, null));
                                    ...
                                    var o =
                                        ...
                                        s = we.getTransitionDurationFromElement(
                                            this._element
                                        );
                                    oe(this._element)
                                        .one(we.TRANSITION_END, function () {
                        ...
                        (e.hide = function () {
                            ...
                            if (
                                ...
                                if (
                                    ...
                                    this.setTransitioning(!0);
                                    this._element.style[n] = "";
                                    var a = we.getTransitionDurationFromElement(
                                        this._element
                                    );
                                    oe(this._element)
                                        .one(we.TRANSITION_END, function () {
    ...
    var wt = {
            ...
            modifiers: {
                ...
                hide: {
                    ...
                    fn: function (e) {
                        if (
                            !pt(e.instance.modifiers, "hide", "preventOverflow")
                        )
                            return e;
                ...
                computeStyle: {
                    ...
                    fn: function (e, t) {
                        ...
                        if (
                            ((p =
                                "bottom" === u ? -a.height + c.bottom : c.top),
        ...
        Ct = (function () {
            function o(e, t) {
                ...
                !(function (e, t) {
                    ...
                    Object.keys(
                        ze({}, o.Defaults.modifiers, i.modifiers)
                    ).forEach(function (e) {
                ...
                return (
                    (e.toggle = function () {
                        if (
                            ...
                            if ((c._clearMenus(), !t)) {
                                ...
                                if (
                                    (Tt(e).trigger(i), !i.isDefaultPrevented())
                                ) {
                                    if (!this._inNavbar) {
                    ...
                    (e._getPlacement = function () {
                        ...
                        return (
                            e.hasClass(Lt)
                                ? ((t = Kt),
                                  Tt(this._menu).hasClass(Mt) && (t = Qt))
                                : e.hasClass(jt)
                                ? (t = zt)
                                : e.hasClass(Ht)
                                ? (t = Gt)
        ...
        qi =
            ...
            (vn = (function () {
                ...
                return (
                        ...
                        if (
                            ...
                            if (
                                ...
                                if (
                                    ...
                                    var r = we.getTransitionDurationFromElement(
                                        this._element
                                    );
                                    $t(this._element)
                                        .one(we.TRANSITION_END, function (e) {
                    ...
                    (e._getConfig = function (e) {
                        return (
                            (e = l({}, on, e)), we.typeCheckConfig(en, e, sn), e
                        );
                    }),
                    (e._showElement = function (e) {
                        ...
                        if (n) {
                            var o = we.getTransitionDurationFromElement(
                                this._element
                            );
                            $t(this._dialog)
                    ...
                    (e._setEscapeEvent = function () {
                        ...
                        this._isShown && this._config.keyboard
                            ...
                            : this._isShown ||
                              $t(this._element).off(an.KEYDOWN_DISMISS);
                    }),
                    ...
                    (e._showBackdrop = function (e) {
                        ...
                        if (this._isShown && this._config.backdrop) {
                            if (
                                ...
                                return;
                            if (!n) return void e();
                            var i = we.getTransitionDurationFromElement(
                                this._backdrop
                            );
                            $t(this._backdrop)
            ...
            (Rn = (function () {
                ...
                return (
                    ...
                    (e.getTipElement = function () {
                        return (
                            (this.tip =
                                this.tip || yn(this.config.template)[0]),
                            this.tip
                        );
                    }),
                    ...
                    (e._enter = function (e, t) {
                        ...
                        (t = t || yn(e.currentTarget).data(n)) ||
                            ...
                            e &&
                                (t._activeTrigger[
                                    "focusin" === e.type ? Mn : Hn
                                ] = !0),
                            yn(t.getTipElement()).hasClass(Pn) ||
                            t._hoverState === On
                                ? (t._hoverState = On)
            ...
            (ti = (function (e) {
                ...
                return (
                    ...
                    (r.getTipElement = function () {
                        return (
                            (this.tip =
                                this.tip || Un(this.config.template)[0]),
                            this.tip
                        );
                    }),
            ...
            (Ci = (function () {
                ...
                return (
                    ...
                    (e._activate = function (t) {
                        ...
                        n.hasClass(ui)
                            ? (n.closest(vi).find(Ei).addClass(fi),
                              n.addClass(fi))
                            : (n.addClass(fi),
                              n
                                  .parents(pi)
