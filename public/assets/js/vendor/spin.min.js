(function (t, e) {
    ...
    function n(t, e) {
        var i,
            ...
            r = t.style;
        for (
            e = e.charAt(0).toUpperCase() + e.slice(1), n = 0;
            d.length > n;
            n++
        )
                ...
                function s(t, s, l) {
                    e(
                        ...
                        e(
                            ...
                            e(
                                r(i("roundrect", { arcsize: n.corners }), {
                                    width: u,
                                    height: n.width,
                                    left: n.radius,
                                    top: -n.width >> 1,
    ...
    (s.defaults = {}),
        o(s.prototype, {
            spin: function (e) {
                ...
                var i = this,
                    n = i.opts,
                    o = (i.el = r(t(0, { className: n.className }), {
                        position: n.position,
                        width: 0,
                        zIndex: n.zIndex,
                    }));
                if (
                    (n.radius + n.length + n.width,
                    r(o, { left: n.left, top: n.top }),
            ...
            lines: function (n, o) {
                ...
                for (
                    var l, d = 0, c = ((o.lines - 1) * (1 - o.direction)) / 2;
                    o.lines > d;
                    d++
                )
                    (l = r(t(), {
                        ...
                        o.shadow &&
                            e(l, r(s("#000", "0 0 4px #000"), { top: "2px" })),
