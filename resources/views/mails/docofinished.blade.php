                                        ...
                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                            <tr>
                                                <td align="center"
                                                    ...
                                                    class="padding-copy">Su archivo de {{ $data }} ha sido
                                                    Procesado.
                                                </td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                <td align="center"
                                                    style="font-size: 20px; font-family: Helvetica, Arial, sans-serif; color: #333333;"
                                                    class="padding-copy">Total de Registros Conciliados:
                                                    {{ $procesados }}.
                                                </td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                <td align="center" style="padding: 25px 0 0 0;" class="padding-copy">
                                                    <table border="0" cellspacing="0" cellpadding="0"
                                                        ...
                                                        <tr>
                                                            <td align="center"><a
                                                                    href="http://eureka.vepagos.com/services/reportInvoiceDetail"
                                                                    target="_blank"
                                                                    ...
                                                                    class="mobile-button">Ir a Reporteria &rarr;</a>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td><br></td>
