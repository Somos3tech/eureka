...
<header class=" main-header bg-white d-flex justify-content-between p-2">
    <div class="header-toggle">
        ...
        <i class="i-Email mr-3 text-20 mobile-hide cursor-pointer" data-toggle="tooltip" data-placement="top"
    ...
    <div class="header-part-right">
        <!-- Full screen toggle -->
        <i class="i-Full-Screen-2 header-icon d-none d-sm-inline-block" data-fullscreen=""></i>
        <!-- Grid menu Dropdown -->
