...
<body>
    ...
    <div class="container">
        <div class="box">
            ...
            <p>Actualmente el aplicativo se encuentra en mantenimiento, <br>por favor vuelve a intentar mas tarde.</p>
            <p>Contacto a<a href="mailto:sistemas@vepagos.com" target="_blank">Soporte</a></p>
        </div>
    </div>
    <!-- partial -->
